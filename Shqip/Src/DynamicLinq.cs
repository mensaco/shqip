...
namespace System.Linq.Dynamic
{
    ...
    internal class ClassFactory
    {
        ...
        private ClassFactory()
        {
            ...
            AssemblyBuilder assembly = AssemblyBuilder.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run); // MI changed according to https://stackoverflow.com/questions/36937276/is-there-any-replace-of-assemblybuilder-definedynamicassembly-in-net-core
    ...
    internal class ExpressionParser
    {
        ...
        static readonly Type[] predefinedTypes = {
            ...
            typeof(Math),
            typeof(Convert),
            //typeof(System.Data.Objects.EntityFunctions) // MI could not fix the error. won't be needing this part so as hack i just hacked it :)
        };
